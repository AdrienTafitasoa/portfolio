...
export const educations = [
  {
    ...
    servIcon: <img loading="lazy" className="h-[4.25rem] w-[4.25rem] fill-white" src={bacc}/>,
  ...
  },
  {
    ...
    descColor: "text-[#070815]",
    servIcon: <img loading="lazy" className="h-[4.25rem] w-[4.25rem] fill-white" src={licence}/>,
  ...
  },
  {
    ...
    titleColor: "text-accent2",
    descColor: "text-[#070815]",
    servIcon: <img loading="lazy" className="h-[7rem] w-[4.9rem] fill-white" src={inclusiv}/>,
